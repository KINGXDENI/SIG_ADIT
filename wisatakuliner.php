  ...
  <section id="services" class="services service-section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <h2><?php echo $data['nama_kuliner']; ?></h2>
      ...
      <?php 
                    ...
                    <br><br>  <br><br>  <br><br>  <br><br>
                      ...
                      <br>
                      <br>
                      <a href="form_simpan_kuliner.php"><input type="submit" class="btn btn-large" value="Tambah Data"  ></a>
                      <br>
                      <br>
              <table border="2" width="100%">
                ...
                include "koneksi.php";
                      ...
                      $query = "SELECT * FROM wisatakuliner"; // Query untuk menampilkan semua data galeri
                      $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
  
                while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                      echo "<tr>";
                      echo "<td align='center'><img src='images/foto/".$data['foto']."' width='400' height='200' ></td>";
                      echo "<td>".$data['nama_kuliner']."</td>";
                      echo "<td>".$data['deskripsi']."</td>";
                      echo "<td>".$data['alamat']."</td>";
                      echo "<td>".$data['notelp_pengelola']."</td>";
                      echo "<td><a href='form_ubah_kuliner.php?id_kuliner=".$data['id_kuliner']."'>Ubah</a></td>";
                      echo "<td><a href='proses_hapus_kuliner.php?id_kuliner=".$data['id_kuliner']."'>Hapus</a></td>";
                      echo "</tr>";
                  }
                ?>
              </table>                    
