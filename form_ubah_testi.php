...
<section  class="section intro">
  ...
  // Ambil data id yang dikirim oleh testimonial.php melalui URL
  ...
  <tr>
    ...
    if($data['jenis_wisata'] == "Wisata Alam"){
      ...
      echo "<input type='radio' name='jenis_wisata' value='Wisata Budaya'> Wisata Budaya";
      echo "<input type='radio' name='jenis_wisata' value='Wisata Kuliner'> Wisata Kuliner";
    }elseif($data['jenis_wisata'] == "Wisata Budaya"){
      echo "<input type='radio' name='jenis_wisata' value='Wisata Budaya' checked='checked'> Wisata Budaya";
      echo "<input type='radio' name='jenis_wisata' value='Wisata Kuliner'> Wisata Kuliner";
      echo "<input type='radio' name='jenis_wisata' value='Wisata Alam'> Wisata Alam";
    }else{
      echo "<input type='radio' name='jenis_wisata' value='Wisata Kuliner' checked='checked'> Wisata Kuliner";
      echo "<input type='radio' name='jenis_wisata' value='Wisata Budaya'> Wisata Budaya";
      echo "<input type='radio' name='jenis_wisata' value='Wisata Alam'> Wisata Alam";
