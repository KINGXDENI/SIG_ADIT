...
<body>
    <section class="section intro">
        <h6 align="center">Tambah Data Budaya</h6>
        <form method="post" action="proses_simpan_budaya.php" enctype="multipart/form-data">
            <table cellpadding="20" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="nama_budaya"></td>
                </tr>
                <tr>
                    <td>Deskripsi</td>
