...
<section  class="section intro">
  <h6 align="center">Ubah data Wisata Alam</h6>
  ...
  $id_alam = isset($_GET['id_alam'])?$_GET['id_alam']:"";
  ...
  <form method="post" action="proses_ubah_alam.php?id_alam=<?php echo $id_alam; ?>" enctype="multipart/form-data">
  ...
  <tr>
   ...
   <tr> -->
                    ...
                    <td><p><textarea name="nama_alam" ><?php echo $data['nama_alam']; ?></textarea></p></td>
                </tr>
                <tr>
                    <td>Deskripsi</td>
