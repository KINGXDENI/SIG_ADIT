...
<body>
    <a href="https://chat.whatsapp.com/Ian6DH3TQTtGLWAmqQ7n4B" class="whatsapp-button">Hubungi via WhatsApp</a>
</body>
      ...
      <?php 
                    ...
                    <br><br>  <br><br>  <br><br>  <br><br>
                      ...
                      <br>
                      <br>
                      <a href="form_simpan_alam.php"><input type="submit" class="btn btn-large" value="Tambah Data"  ></a>
                      <br>
                      <br>
              <table border="2" width="100%">
                ...
                include "koneksi.php";
                      ...
                      $query = "SELECT * FROM wisataalam"; // Query untuk menampilkan semua data galeri
                      $sql = mysqli_query($connect, $query); // Eksekusi/Jalankan query dari variabel $query
  
                while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
                      echo "<tr>";
                      echo "<td align='center'><img src='images/foto/".$data['foto']."' width='400' height='200' ></td>";
                      echo "<td>".$data['nama_alam']."</td>";
                      echo "<td>".$data['deskripsi']."</td>";
                      echo "<td>".$data['alamat']."</td>";
                      echo "<td>".$data['notelp_pengelola']."</td>";
                      echo "<td><a href='form_ubah_alam.php?id_alam=".$data['id_alam']."'>Ubah</a></td>";
                      echo "<td><a href='proses_hapus_alam.php?id_alam=".$data['id_alam']."'>Hapus</a></td>";
                      echo "</tr>";
                  }
                ?>
              </table>                    
