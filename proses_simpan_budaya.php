...
if (move_uploaded_file($tmp, $path)) { // Cek apakah gambar berhasil diupload atau tidak
    ...
    $query = "INSERT INTO wisatabudaya VALUES('" . $id_budaya . "','" . $nama_budaya . "', '" . $deskripsi . "', '" . $alamat . "','" . $notelp_pengelola . "','" . $maps . "','" . $fotobaru . "')";
    ...
    if ($sql) { // Cek jika proses simpan ke database sukses atau tidak
        ...
        echo "<br><a href='form_simpan_budaya.php'>Kembali Ke Form</a>";
    }
} else {
