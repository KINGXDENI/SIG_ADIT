...
<head>
    ...
    <title>Registrasi - PRINGGASELA RAYA</title>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a  href="index.php"><img src="images/pringgaselatourism.png" style="width:130px; height: 50px"></a>
            </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nama_user" placeholder="Nama user" required class="form-control" />
                        </div>
                        </br>
                        <div class="input-group">
