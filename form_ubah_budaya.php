...
<section  class="section intro">
  <h6 align="center">Ubah data Wisata Budaya</h6>
  ...
  $id_budaya = isset($_GET['id_budaya'])?$_GET['id_budaya']:"";
  ...
  <form method="post" action="proses_ubah_budaya.php?id_budaya=<?php echo $id_budaya; ?>" enctype="multipart/form-data">
  ...
  <tr>
   ...
   <tr> -->
                    <td>Nama Wisata Budaya</td>
                    <td><p><textarea name="nama_budaya" ><?php echo $data['nama_budaya']; ?></textarea></p></td>
                </tr>
                <tr>
                    <td>Deskripsi</td>
  ...
  <td><a href="wisatabudaya.php"><input type="button" value="Batal"></a></td>
  </table>
  </form>
    <br>
  <br>
