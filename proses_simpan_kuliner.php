...
if (move_uploaded_file($tmp, $path)) { // Cek apakah gambar berhasil diupload atau tidak
    ...
    $query = "INSERT INTO wisatakuliner VALUES('" . $id_kuliner . "','" . $nama_kuliner . "', '" . $deskripsi . "', '" . $alamat . "','" . $notelp_pengelola . "','" . $maps . "','" . $fotobaru . "')";
    ...
    if ($sql) { // Cek jika proses simpan ke database sukses atau tidak
        ...
        echo "<br><a href='form_simpan_kuliner.php'>Kembali Ke Form</a>";
    }
} else {
