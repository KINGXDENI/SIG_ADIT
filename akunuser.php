...
if(isset($_POST['daftarSubmit'])){
    ...
    if(!empty($_POST['nama_user']) && !empty($_POST['email']) && !empty($_POST['telp']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])){
    ...
    if(!empty($_POST['email']) && !empty($_POST['password'])){
        ...
        if($userData){
            ...
            $sesiData['userID'] = $userData['id_user'];
            $sesiData['status']['type'] = 'sukses';
            $sesiData['status']['msg'] = 'Selamat Datang '.$userData['nama_user'].'!';
